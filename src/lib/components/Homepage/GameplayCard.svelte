<div
	class="col-span-3 row-span-3 flex items-center justify-center rounded-xl bg-muted/40 shadow-lg md:col-span-3 md:row-span-3 lg:col-span-2 lg:row-span-3"
>
	<a
		href="/playground"
	...
	>
		<h1 class="text-lg md:text-xl">Playground</h1>
		<p
